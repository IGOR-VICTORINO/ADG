...
<body>
  <div class="containerForm">
    <h1 onclick="formRelatosclose()" class="back">X</h1>
    <form class="formRelato" action="./mtds/postRelato.php" method="post">
      <div class="boximgText">
        <img src="./imgs/dev/nicollas.jpg" alt="" class="imgRelato">
        <textarea class="textNomerelato" name="nomeRelato" placeholder="Digite seu nome aqui..."></textarea>
      </div>

      <br>
      <textarea class="textRelato" name="Relato" placeholder="Digite seu texto aqui..."></textarea>

      <button class="btn-form" name="submit">
        <span class="transition"></span>
        <span class="gradient"></span>
        <span class="label">Enviar Relato</span>
      </button>
    </form>
  </div>
  <br />
  ...
  <nav class="navbar fixed-top">
    <div class="container-fluid">
      ...
      <div class="container-navbaritem">
        <a class='btnRel' onclick="formRelatos()">
          <li>Faça seu relato</li>
  ...
  <header class="ContainerRelatos">
    <div class="navRelatos">
      <img class="bandeira" src="imgs/relatos/ttRelatos.png" alt="" />
    </div>
    <div class="containerRela">
      <?php
      include_once('./mtds/getRelato.php')
      ?>
    </div>
  </header>
