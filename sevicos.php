...
<body>
  ...
  <h2 id="servicos" class="ttl-categorias">
    ONGs
  </h2>
  <br>
  <br>
  <div class="containerServ" id="servicos">
    <div class="boxCardServ">
      <a href="https://doe.aldeiasinfantis.org.br/torne-se-um-amigo-sos/people/new?utm_source=site&utm_medium=menu&utm_campaign=doacao"
        class="e-card playing" style="text-decoration: none;">
        <div>
          <div class="image"></div>
          ...
          <div class="infotop">
            <img class="imgCradServ" src="./imgs/ongs/ong1.png" alt="" /><br />
            Aldeias Infantis SOS
            <br />
          </div>
        </div>
      </a>
      <a href="https://www.childhood.org.br/saiba-como-agir/doe/" class="e-card playing" style="text-decoration: none;">
        <div>
          <div class="image"></div>
          ...
          <div class="infotop">
            <img class="imgCradServ" src="imgs/ongs/ong2.png" alt="" /><br />
            Childhood Brasil
            <br />
          </div>
        </div>
      </a>
      <a href="https://lifeimpactbrasil.org/doacoes/" class="e-card playing" style="text-decoration: none;">
        <div>
          <div class="image"></div>
          ...
          <div class="infotop">
            <img class="imgCradServ" src="imgs/ongs/ong3.png" alt="" />
            <br />
            LifeImpactBrasil
            <br />
          </div>
  ...
  <div class="containerServ" id="servicos">
    <div class="boxCardServ">
      <a href="https://henryborel.com.br/quero-doar/" class="e-card playing" style="text-decoration: none;">
        <div>
          <div class="image"></div>
          ...
          <div class="infotop">
            <img class="imgCradServ" src="imgs/ongs/ong4.png" alt="" /><br />
            Henry Borel
            <br />
          </div>
        </div>
      </a>
      <a href="https://maiolaranja.org.br/" class="e-card playing" style="text-decoration: none;">
        <div>
          <div class="image"></div>
          ...
          <div class="infotop">
            <img class="imgCradServ" src="imgs/ongs/ong5.png" alt="" /><br />
            Maio Laranja
            <br />
          </div>
        </div>
  ...
  <div class="containerServ" id="servicos">
    <div class="boxCardServ">
      <a href="https://api.whatsapp.com/send/?phone=5511967299504&text=Ol%C3%A1%2C+estou+entrando+em+contato+por+meio+da+ADG.+Gostaria+de+conversar+com+voc%C3%AA%21%21&type=phone_number&app_absent=0"
        class="e-card playing" style="text-decoration: none;">
        <div>
          <div class="image"></div>
          ...
          <div class="infotop">
            <img class="imgCradServ" src="./imgs/psicologos/felipe.jpg" alt="" /><br />
            Felipe Fernandes
            <br />
          </div>
        </div>
      </a>
      <a href="https://api.whatsapp.com/send/?phone=5511948525168&text=Ol%C3%A1%2C+estou+entrando+em+contato+por+meio+da+ADG.+Gostaria+de+conversar+com+voc%C3%AA%21%21&type=phone_number&app_absent=0"
        class="e-card playing" style="text-decoration: none;">
        <div>
          <div class="image"></div>
          ...
          <div class="infotop">
            <img class="imgCradServ" src="imgs/psicologos/rubens.jpg" alt="" /><br />
            Rubens Dos Santos
            <br />
          </div>
        </div>
      </a>
      <a href="https://api.whatsapp.com/send/?phone=5511930093059&text=Ol%C3%A1%2C+haby&type=phone_number&app_absent=0"
        class="e-card playing" style="text-decoration: none;">
        <div>
          <div class="image"></div>
          ...
          <div class="infotop">
            <img class="imgCradServ" src="imgs/psicologos/andressa.jpg" alt="" />
            <br />
            Andressa Carvalho
            <br />
          </div>
  ...
  <br id="app">
<hr>
  <div class="containerServ" style="display: flex; justify-content: space-evenly;"  id="servicos">

  <img src="imgs/servicos/qrImg.png" alt="" class="qr">
  <div class="box-text">
    <h1 class="ttlApp">ADG App</h1>
    <h1 class="subttl">Um aplicativo para proteger e apoiar</h1>
    <h1 class="text">
      . Espaço seguro para relatos<br>
       . Notícias atualizadas<br>
        . Recursos profissionais<br> 
        . Rede de apoio</h1>
  </div>
  </div>
  <footer class="rodape">
